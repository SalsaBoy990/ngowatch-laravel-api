...
@section('content')
    ...
    <div class="content-600 public-account">
        ...
        <h1 class="h2 margin-top-0 text-center"><span class="text-gray-60">Tag: </span>{{ $tag->name }}</h1>
                ...
                <article class="card round">
                    <a href="{{ route('public.gallery', [$user->userHandle, $gallery->slug]) }}">
                        <div class="relative margin-bottom-0-5">
                            ...
                            <div
                                class="badge gray-60 fs-14 absolute topleft margin-left-0-5 margin-top-0-5">
